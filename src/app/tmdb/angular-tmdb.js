...
angular.module('tmdb', [])
    ...
    .service('tmdbMovie', ['TMDB', '$http', function (TMDB, $http) {
        ...
        this.moviesGenres = function (onSuccess, onError) {
            var request = TMDB.API_URL + 'genre/movie/list?api_key=' + TMDB.API_KEY + '&language=en-US';
    ...
    .service('tmdbTV', ['TMDB', '$http', function (TMDB, $http) {
        ...
        this.tvGenres = function (onSuccess, onError) {
            var request = TMDB.API_URL + 'genre/movie/list?api_key=' + TMDB.API_KEY + '&language=en-US';
            $http.get(request).success(function (data, status, headers, config) {
                if (onSuccess !== undefined)
                    onSuccess(data, status, headers, config);
